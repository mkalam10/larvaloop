...
const brandLogoImg = "/src/assets/images/larvaloop_brand_logo_1786627201813.jpg";
...
export const LarvaLoopLogo: React.FC<LarvaLoopLogoProps> = ({
  ...
  if (isHeader) {
    return (
      <div className={`flex items-center bg-white/95 backdrop-blur-sm px-2 py-1 rounded-xl border border-white/40 shadow-sm ${className}`}>
        <img
          src={brandLogoImg}
          alt="LarvaLoop Logo"
